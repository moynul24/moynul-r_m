...
def song_list():
       os.system("play-audio 'xoxo_my_baby_slow_down_bass🎵🎧🎧🎧🎧(256k).mp3'")
       os.system("play-audio 'Ashi_bola_galo_bondhu_ailo_na_ra_ashi_bola_galo_bondhu_ailo_na(256k).mp3'")
       os.system("play-audio 'Tumi_Purnimari_Alo___Samz_Vai___Bangla_Song_2019___Official_MV___Bangladeshi_Song___Eagle_Music(256k).mp3'")
       os.system("play-audio 'Amar_moner_majhe_tui_chara_keu_nai____Samz_Vai____Biswas___New_music_video_2019(256k).mp3'")
       os.system("play-audio 'Amay_chere_kokhono_tumi_jabe_na_Samz_Vai(256k).mp3'")
       os.system("play-audio 'Vulite_Paribona___Samz_Vai___Bengali_New_Song_2023(256k).mp3'")
       os.system("play-audio ''jvla_-_such_a_whole__potato_remix__slowed___reverb(256k).mp3'")
       os.system("play-audio ''Rauf___Faik_-_childhood___slowed_and_reverb_(256k).mp3'")
       os.system("play-audio ''T3NZU_-_Kosandra___Kasandra__Peaky_Blinders_(256k).mp3'")
       os.system("play-audio ''Joker_bgm_8D_AUDIO__Bass_Boosted__Use_Headphone(256k).mp3'")
       os.system("play-audio ''Ya_lili[_slowed_reverb_]____Sohail_Musics____Feel_The_Music(256k).mp3'")
       os.system("play-audio ''Cocaina___Clandestina__Zusebi_Remix__[TikTok](256k).mp3'")
       os.system("play-audio ''CJ_-_WHOOPTY__ERS_Remix_____[_Fixima_Lai_Mafia_](256k).mp3'")
       os.system("play-audio ''CVRTOON_-_Izmir_Marsi(256k).mp3'")
       os.system("play-audio ''AINSI_BAS_LA_VIDA_-_Indila____ENES_Music____Lofi_Slowed_and_Reverb__ЁЯе░ЁЯОзЁЯОз_Harmonized_(256k).mp3'")
def main():
       print("logo")
       hero=input("choice:")
